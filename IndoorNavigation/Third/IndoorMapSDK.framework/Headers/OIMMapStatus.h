...
@interface OIMMapStatus : NSObject
...
/*!
 @brief 地图的视图锚点。坐标系归一化，(0, 0)为OIMMapView左上角，(1, 1)为右下角。默认为(0.5, 0.5)，即当前地图的视图中心。
 */
...
/*!
 ...
 @param screenAnchor 地图的视图锚点。坐标系归一化，(0, 0)为OIMMapView左上角，(1, 1)为右下角。默认为(0.5, 0.5)，即当前地图的视图中心。
 @return 生成的Status
 */
