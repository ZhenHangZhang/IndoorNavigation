...
/*!
 @brief 该类用于确定覆盖在地图上的图片，及其覆盖区域, 通常OIMGroundOverlay是OIMGroundOverlayView的model
 */
@interface OIMGroundOverlay : OIMOverlay
...
/*!
 @brief 图片在地图中的覆盖范围
 */
@property (nonatomic, readonly) OIMCoordinateBounds bounds;
 ...
 */
+ (instancetype)groundOverlayWithBounds:(OIMCoordinateBounds)bounds
                                   icon:(UIImage *)icon;
